...
function getCallbackBanner(): { type: "success" | "error"; message: string } | null {
  ...
  if (connected === "facebook")
    return { type: "success", message: `Facebook connected! ${pages ? `${pages} page(s) added.` : ""}` };
  if (error === "facebook_denied") return { type: "error", message: "Facebook connection was cancelled." };
  ...
  if (error === "facebook_failed") return { type: "error", message: "Facebook connection failed. Check your server configuration and try again." };
  return null;
}
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <p>To connect real Facebook Pages:</p>
            ...
            <CardFooter className="pt-0 flex gap-2">
              {account.connectionStatus === "not_connected" ? (
                account.platform === "facebook"
                  ? <Button className="w-full" onClick={connectFacebook}><Facebook className="w-4 h-4 mr-2" />Connect via Facebook</Button>
