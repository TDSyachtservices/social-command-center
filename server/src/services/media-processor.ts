...
export const IMAGE_PLATFORM_SPECS: PlatformSpec[] = [
  ...
  { platform: "FACEBOOK",  placement: "feed_portrait",  width: 1080, height: 1350, aspectRatio: "4:5",    format: "jpeg", mimeType: "image/jpeg" },
  { platform: "FACEBOOK",  placement: "story",          width: 1080, height: 1920, aspectRatio: "9:16",   format: "jpeg", mimeType: "image/jpeg" },
  { platform: "INSTAGRAM", placement: "feed_square",    width: 1080, height: 1080, aspectRatio: "1:1",    format: "jpeg", mimeType: "image/jpeg" },
  { platform: "INSTAGRAM", placement: "feed_portrait",  width: 1080, height: 1350, aspectRatio: "4:5",    format: "jpeg", mimeType: "image/jpeg" },
